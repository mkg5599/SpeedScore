...
function login(userId) {
  ...
  GlobalProfileBtn.style.backgroundImage =
    "url(" + GlobalUserData.identityInfo.profilePic + ")";
...
loginForm.addEventListener("submit", function (e) {
  ...
  let emailValid =
    !GlobalEmailField.validity.typeMismatch &&
    !GlobalEmailField.validity.valueMissing;
  //Is the password field valid?
  let passwordValid =
    !GlobalPasswordField.validity.patternMismatch &&
