...
var GlobalAboutBox = new bootstrap.Modal(
  document.getElementById("aboutSpeedScore")
);
...
const GlobalModeTabButtons = document.querySelectorAll("button[role='tab']");
//Array of mode tab panel elements:
const GlobalModeTabPanels = document.querySelectorAll("div[role='tabpanel']");
...
const GlobalModeActionButtons = document.querySelectorAll("button.float-btn");
//array of mode action dialog boxes
const GlobalModeActionDialogs = document.querySelectorAll("div.action-dialog");
//array of "OK" buttons within the dialog boxes
const GlobalDialogActionButtons = document.querySelectorAll(
  "button.action-button"
);
//array of "Cancel" buttons within the dialog boxes
const GlobalDialogCancelButtons = document.querySelectorAll(
...
const GlobalAccountCreatedClose = document.getElementById(
  "accountCreatedClose"
);
const GlobalAccountCreatedEmail = document.getElementById(
  "accountCreatedEmail"
);
...
/*****************************************************/
const GlobalCreateAccountDialog = document.getElementById(
  "createAccountDialog"
);
const GlobalSubmitCreateAccountBtn = document.getElementById(
  "submitCreateAccountBtn"
);
const GlobalCancelCreateAccountBtn = document.getElementById(
...
const GlobalAcctPasswordRepeatField =
  document.getElementById("acctPasswordRepeat");
...
const GlobalAcctProfilePicImage = document.getElementById(
  "acctProfilePicImage"
);
const GlobalAcctSecurityQuestionField = document.getElementById(
  "acctSecurityQuestion"
);
const GlobalAcctSecurityAnswerField =
  document.getElementById("acctSecurityAnswer");
...
const GlobalAcctPasswordRepeatErr = document.getElementById(
  "acctPasswordRepeatError"
);
const GlobalAcctDisplayNameErr = document.getElementById(
  "acctDisplayNameError"
);
const GlobalAcctSecurityQuestionErr = document.getElementById(
  "acctSecurityQuestionError"
);
const GlobalAcctSecurityAnswerErr = document.getElementById(
  "acctSecurityAnswerError"
);
...
/*****************************************************/
const GlobalProfileSettingsDialog = document.getElementById(
  "profileSettingsDialog"
);
const GlobalAccountSettingsBtn = document.getElementById("accountSettingsBtn");
const GlobalAccountSettingsPanel = document.getElementById(
  "accountSettingsPanel"
);
const GlobalProfileSettingsBtn = document.getElementById("profileSettingsBtn");
const GlobalProfileSettingsPanel = document.getElementById(
...
const GlobalProfileDisplayNameErr = document.getElementById(
  "profileDisplayNameError"
);
const GlobalProfileSecurityQuestionErr = document.getElementById(
  "profileSecurityQuestionError"
);
const GlobalProfileSecurityAnswerErr = document.getElementById(
  "profileSecurityAnswerError"
);
...
const GlobalProfileSecurityQuestionField = document.getElementById(
  "profileSecurityQuestion"
);
const GlobalProfileSecurityAnswerField = document.getElementById(
  "profileSecurityAnswer"
);
const GlobalProfileDisplayNameField =
...
const GlobalProfileClubsInBagChecks = document
  .getElementById("clubsDiv")
  .querySelectorAll("input");
const GlobalProfileClubCommentsField =
  document.getElementById("sgClubComments");
const GlobalCancelUpdateProfileBtn = document.getElementById(
...
const GlobalRoundFormSubmitBtnLabel = document.getElementById(
  "roundFormSubmitBtnLabel"
);
const GlobalRoundFormSubmitBtnIcon = document.getElementById(
  "roundFormSubmitBtnIcon"
);
...
const GlobalRoundsTableSortableColHeaders =
  document.getElementsByClassName("sortable-header");
const GlobalRoundsTableSortBtns =
  document.getElementsByClassName("table-sort-btn");
...
const GlobalDialogPrepFuncs = [
  () => {},
  () => prepLogRoundForm(),
  () => {},
  () => {},
];
const GlobalDialogTitles = [
  "SpeedScore: Post to Feed",
  "SpeedScore: Log Round",
  "SpeedScore: Add Course",
  "SpeedScore: Find Buddies",
];
